...
namespace TravelPlannerV2.TPs
{
    public partial class Edit : System.Web.UI.Page
    {
        ...
        // This is the Update methd to update the selected TP item
        // USAGE: <asp:FormView UpdateMethod="UpdateItem">
        public void UpdateItem(int  Id)
        {
            using (_db)
            {
                var item = _db.TPs.Find(Id);
        ...
        // This is the Select method to selects a single TP item with the id
